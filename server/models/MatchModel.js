...
class Match {
  // Crea un nuovo match
 static async create({ tournamentId, team1Id, team2Id, scoreTeam1, scoreTeam2, matchDate, status = "scheduled" }) {
  const [result] = await pool.execute(
    `INSERT INTO matches 
      (tournament_id, team1_id, team2_id, score_team1, score_team2, match_date, status)
     VALUES (?, ?, ?, ?, ?, ?, ?)`,
    [
      tournamentId,
      team1Id,
